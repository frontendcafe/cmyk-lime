...
import styles from '../pages/intro/estilos/Intro.module.css';
import Link from 'next/link';
import { motion, useCycle, AnimatePresence } from 'framer-motion';
import { IconHome } from './intro/components/IconHome';
     ...
     return(
         <>
            <motion.p className={styles.text_circle01}
                ...
                animate={{ y: 1, duration: 4, opacity : 1,  transition : {  delay: 3, duration: 3, easing: [0.42, 0, 0.60, 1]}}} 
    ...
    return(
        <>
            <motion.div className={styles.circle02}
                ...
                animate={{y: 1, scale: 1, transition:{ duration: 2, easing: [0.42, 0, 0.58, 1] }}}
         ...
         <>
             <motion.div className={styles.circle03}
               initial={{rotate: [0,360,0, 360, 0, 360], scale: 0, duration: 0.5 }}
                animate={{ scale: 1, transition:{ duration: 1, easing: [0.42, 0, 0.60, 1]  }}}
     ...
     return(
        <>
            <motion.div className={styles.circle04}
                ...
                animate={{ opacity: 1, rotate: 360, transition: { easings: [0.56, 8, 0.56, 8], type: "spring", delay: 0.4, duration: 2}}}
            ...
            <motion.p className={styles.text_circle04}
                ...
                >¡muchas cosas pueden pasar!</motion.p>
                <div>
                    <HomeButton/>
                </div> 
        </>
